...
public class VisualBlueprintEditor extends RenderableObject
	{
				...
				if (showHelp)
					{
						...
						g.drawString("Press 's' to switch a Neurons type.", 4, ++i * 15);
				...
				else
					{
						...
						g.drawString("Neurons: " + blueprints.neuronNodes.size(), 4, 290);
		...
		protected void keyPressed(KeyEvent event)
			{
				if (event.getKeyChar() == 'n')
					...
					selectedNode.inhibitor = !selectedNode.inhibitor;
