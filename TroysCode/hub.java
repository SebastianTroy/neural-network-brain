...
public class hub
	{
		 ...
		 * {@link Frame} Class.
		 */
		public static final String programName = "Testing for my synthetic 'brain'";
		/**
		 * This is added to the title of the program's frame in the
		 * {@link Frame} Class. It can also be used to track compatability due
		 * to version differences.
		 */
		public static final String versionNumber = "0.1_00";
		/**
		...
		public static void main(String[] args)
			{
				frame.startFrame();
				hub.renderer.setStartRenderableObject(menu);
				hub.renderer.begin();
			}
	}
